 ...
 */
public class CellFile implements Callback<ListView<String>,ListCell<String>>{
    @Override
        ...
        ListCell<String> cell = new ListCell<String>(){
            ...
            protected void updateItem(String user, boolean bln) {
                ...
                if (user != null) {
                    ...
                    Image image = new Image(getClass().getClassLoader().getResource("file.jpg").toString(),50,50,true,true);
