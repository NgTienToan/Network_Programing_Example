...
public class MainController implements Initializable {
    ...
    public void sendButtonAction(MouseEvent mouseEvent) {
        ...
        sendMessage(toServerMessage.toString());
    }
    ...
    public void setUserList(List<String> userList) {
        ...
        Platform.runLater(() -> {
            ObservableList<String> users = FXCollections.observableList(onlineUsers);
            userListBox.setItems(users);
            userListBox.setCellFactory(new CellRenderer());
        });

        onlineUsers.stream().forEach(e -> {
            usersChatMessage.put(e, new ArrayList<String>());
        });
    }

    public void setGroupList(String groupName) {
        onlineUsers.add(groupName);
        Platform.runLater(() -> {
            ObservableList<String> users = FXCollections.observableList(onlineUsers);
            userListBox.setItems(users);
            userListBox.setCellFactory(new CellRenderer());
        ...
        sendMessage(Constant.GROUP_CREATE);
    }
    ...
    public void onClickCreateGroupButton(MouseEvent mouseEvent) {
        Stage primaryStage = new Stage();
        FXMLLoader root = new FXMLLoader(getClass().getResource("../fxml/group_create.fxml"));
        Parent parent = null;
        try {
            parent = root.load();
        } catch (IOException e) {
        ...
        GroupCreateController groupCreateController = root.getController();
        groupCreateController.setMainController(this);
    ...
    public void onClickAddMemember(MouseEvent mouseEvent) {
        Stage primaryStage = new Stage();
        FXMLLoader root = new FXMLLoader(getClass().getResource("../fxml/add_member.fxml"));
        Parent parent = null;
        try {
            parent = root.load();
        } catch (IOException e) {
        ...
        AddMemberController addMemberController = root.getController();
        addMemberController.setMainController(this);
